...
@Documented
@Import({AuthorizationServerEndpointsConfiguration.class, AuthorizationServerSecurityConfigurationWithApiKeySupport.class})
public @interface EnableAuthorizationServerWithApiSupport {
